...
<form id="searchform" class="searchform" role="search" method="get" class="woocommerce-product-search" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
...
<!--<input type="submit" value="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>" />-->
        <input type="submit" id="searchsubmit" alue="<?php echo esc_attr_x( 'Search', 'submit button', 'woocommerce' ); ?>">
