...
function qsoft_facebook_callback_step2() {
    if (get_option('qsoft_facebook_enabled') == 1) {
        $app_id = get_option('qsoft_facebook_app_id');
        $app_secret = get_option('qsoft_facebook_app_secret');
    } else {
...
add_action('wp_ajax_qsoft_facebook_callback2', 'qsoft_facebook_callback_step2');
add_action('wp_ajax_nopriv_qsoft_facebook_callback2', 'qsoft_facebook_callback_step2');
